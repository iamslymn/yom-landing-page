  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-foreground">Əlaqə</h1>
        <div className="prose prose-lg max-w-none text-foreground space-y-8">
          ...
          <section className="bg-muted/50 rounded-lg p-8 space-y-6">
            ...
            <div className="grid md:grid-cols-1 gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">E-poçt</h3>
                  <a 
          ...
          <section className="bg-muted/50 rounded-lg p-8">
            <h2 className="text-2xl font-bold mb-6">Sosial Mediada YOM</h2>
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">LinkedIn-də bizi izləyin</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Instagram-da bizi izləyin</p>
                </div>
              </a>
            </div>
          </section>
